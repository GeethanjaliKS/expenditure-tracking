...
#  year = date.strftime("%Y")
  ...
  axis[0].set_xticks(y_pos,col_cat,color='red',fontsize='10',horizontalalignment='right',rotation=15)
  ...
  axis[1].set_xticks(y_pos,col_cat,color='red',fontsize='10',horizontalalignment='right',rotation=15)
